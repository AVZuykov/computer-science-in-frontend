...
export function homework_1() {
    const accessor8Bit = createBitAccessor(
    ...
    const accessor16Bit = createBitAccessor(
        new Uint16Array([0b0000_1100, 0b0000_1001, 0b1111_1111])
    )
    ...
    const accessor32Bit = createBitAccessor(
        new Uint32Array([0b0000_1100, 0b0000_1001, 0b1111_1111])
    )
